...
gulp.task('watch', gulp.series(gulp.parallel('clean','browser-sync', 'html', 'style', 'scripts', 'img', 'fonts')), function() {
...
gulp.task('build', gulp.series('clean', 'html', 'deploy:style', 'deploy:scripts', 'img', 'fonts', 'localization'));
